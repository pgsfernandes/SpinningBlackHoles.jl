...
export Field, LoadSystem, PrintData, write_data_to_file, interpolate1D, interpolate1D!, interpolate, interpolate!, GetMass, GetJ, GetTh, GetAh, GetωχKerr, GetωχKerrN, quantities_kerr, GetLe, GetLp, Sphericity, vH, get_quantities, fKerrN, gKerrN, hKerrN, WKerrN, AtKerrN, AφKerrN, Print_Petrov, gtt, gtphi, gphiphi, grr, gthetatheta, Ergosphere, CircumferencialRadius, LightRing, ISCO, Ricci_Horizon, GB_Horizon, RicciScalar, GBScalar, X, Mx, Y, My, Nx, Ny
